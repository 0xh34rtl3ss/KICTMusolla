# 922D - Prayer Hall Vacancy Detection using YOLOv5 and Centroid Tracker
# Created by: Muhammad Naqib Syahmi bin Ab Razak (1910147) & Muhammad Imran bin Mohamad (1912837)
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                # After n frames clear unused id
                if num % 40 == 0:
                    for ob in tracked_objects:
                        if ob.remove == 1:
                            tracked_objects.remove(ob)
            ...
            text1 = "{}: {}".format("IN", CountUp)
            cv2.putText(im0, text1, (400, H - 1600), cv2.FONT_HERSHEY_SIMPLEX, 2, (255, 255, 255), 3)
            cv2.line(im0, (300, H - 1500), (W - 300, H - 1500), (0, 255, 0), thickness=line_thickness)
